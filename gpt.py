...
REMEMBER — ต้องการบันทึกว่า @username นี้ชื่ออะไร/มี role อะไร เช่น "จำ @somchai ชื่อ สมชาย", "@somchai คือ สมชาย", "@somchai เป็น admin", "บันทึก @ann ว่าชื่อ อันนา role staff", "เปลี่ยน @somchai เป็น สมชาย"
...
async def detect_intent(text: str) -> str:
    ...
    for intent in ("TEACH", "REMEMBER", "QUERY", "REWRITE", "EXPIRY", "CHAT"):
        if intent in result:
            return intent
    return "CHAT"
